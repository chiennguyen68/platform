                ...
                <div className={styles.container}>
                    <div className={styles.title}>
                        ...
                        <div className={styles.tags}>
                            <Tag className={styles.tag} variant="outline">
                                Food
                            </Tag>
                            <Tag className={styles.tag} variant="outline">
                                Family
